...
export interface KKLCChapterDTO {
    name: string;                // "1", "21", "41"...
    kanji: string;               // "譌･荳莠御ｸ牙香蝗帑ｺ泌・荳・・荵昜ｸｸ蜀・・ｺｺ逋ｾ蜊・ｸ・哨逕ｰ"
}
...
export interface ParsedJPDBFrequency {
    ...
    hiraganaRank?: number;       // 6099 (if 繼・marker present)
}
